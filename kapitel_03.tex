...
% VERSCHLAGWORTUNG(INDEX)=2. Durchlauf
...
\item[4. Abschnitt] Dieses lehrt einen jeden %oder dieser lehrt einen jeden, musst du von der Bedeutung mal überprüfen%
die Erfahrung, und Christus
behauptet es in den Worten: "`\textit{Aus dem Herzen kommen böse \footnote{
"'arge"` duch "'böse"` ersetzt} Gedanken, Mord,
...
das Kreuz zu tragen. (Seite: \pageref{kap3_ab5})
\end{description}
\normalsize
...
''figürliche`` durch ''bildliche`` ersetzt} Redensart, die von dem äußeren
...
beschränktem Verstande und sonderbarer Gemütsart, mit der Milzsucht%hier wäre ne erklärung ganz gut%
 behaftet,
...
Ich antworte: Im Inneren des Herzens, in der Seele. \textbf{Wo die Sünde ist, da zeigt
...
List, Unzucht, ein neidisches Auge, Gotteslästerung, Hoffart%auch hier erklären oder ersetzen%
, Torheit. Alle
...
\index{Sitz der Sünde} und wo nun der Mensch
...
Zustand des geistlichen Todes. \index{geistlicher Tod}Hier haben wir die
...
einwilligen solle. Folgt er nun dieser Warnung, und nimmt auf %aus oder auf? - auf ist korrekt.%
 diese Weise das
