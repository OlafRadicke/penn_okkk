...
\documentclass[pdftex,pagesize, 10pt]{scrbook}
...
% \usepackage{floatflt}
% für die Grapik
% Ersatz für \usepackage{floatflt}
\usepackage{wrapfig}
\usepackage{tikz}
% Endnoten
\usepackage{endnotes}
\renewcommand{\notesname}{Quellennachweis des lexikalischen Anhangs}
...
{$\diamond$\marginpar{\begin{flushleft}\scriptsize{{#1}}\end{flushleft}}}


% Definiton des Komandos \biblecite
% Für Bibelzitate. Erster Wert ist die Randbemerung
...
\addcontentsline{toc}{chapter}{\protect\numberline{12}{Schlagwortverzeichnis}}
\printindex

\pagebreak
\cleardoublepage

\addcontentsline{toc}{chapter}{\protect\numberline{13}{Personenverzeichnis}}
\printindex[person]

\pagebreak
\cleardoublepage

\addcontentsline{toc}{chapter}{\protect\numberline{14}{Bibelstellen}}
\printindex[bibel]

\include{bib}


\addcontentsline{toc}{chapter}{\protect\numberline{15}{Über Claus Bernet}}
\include{claus_vita}
...
Cover-Bild:\\
Alexander Milne Calder sitzend mit der Kopf seiner Statue von William Penn. Diese befindet sich heute auf Philadelphia City Hall.\\
