...
% \newcommand{\biblecite}[2]
% {$\diamond$\marginpar{\footnotesize{{#1}}}{\bibleindex{#2}}}
...
\include{kapitel_01} % CB  Korrektur
\include{kapitel_02} % Heiko,  Korrektur
\include{kapitel_03} % Heiko,CB  Korrektur
\include{kapitel_04} % CB  Korrektur
\include{kapitel_05} % CB  Korrektur
\include{kapitel_06} % CB  Korrektur
\include{kapitel_07} % CB  Korrektur
\include{kapitel_08} % CB  Korrektur
\include{kapitel_09} %   Korrektur
\include{kapitel_10} % CB  Korrektur
\include{kapitel_11} % CB  Korrektur
\include{kapitel_12} % CB  Korrektur
\include{kapitel_13} %   Korrektur
\include{kapitel_14} % CB  Korrektur
\include{kapitel_15} %   Korrektur
\include{kapitel_16} % CB  Korrektur
\include{kapitel_17} % CB  Korrektur
\include{kapitel_18} % CB  Korrektur
...
% Vielleicht eine bessere Überschrift??
\include{biographie_penn} % Toni  Korrektur
...
\include{quaker_geschichte} % Heiko,  Korrektur


\include{uebersicht} % Kurt,  Korrektur
