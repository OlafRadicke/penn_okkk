...
fürchte, und da er keinen Gefallen an dem ewigen Tode \index{ewiger Tod} armer
Sünder hat, wenn
...
wenn Jemand meine Stimme höret, und die Tür aufthut, zu dem werde ich eingehen
...
Nun sage ich dir: Wenn du nicht glaubst, daß Er, der vor der Tür deines Herzens
...
in ihren Herzen aufnehmen, so ist es auch gewiß, daß Diejenigen, die ihn auf
...
\footnote{"`verleugnen"' ersetzt duch "`überwinden"'}
...
könnte auch sonst von dir gesagt werden, daß du Christume aufgenommen habest,
...
Mangel ist
die einzige Ursache deines traurigen Abfalles vom wahren Christentum. Dieses
...
Erscheinung Christi, des Lichtes und Heilandes der Welt, richten möchten, der
...
jene toten Werke mit dem festen Vorsatze erzeugte) hinfort dem lebendigen Gott
...
sie, wie der Apostel Johannes anrät,
...
So lange nun jener ehrliche\footnote{"`lautere"' durch "`ehrliche"' ersezt}
...
den jetzigen Bekennern des cihristentumes normal sind
...
Tanzpartieen, Gastereien und Spielgesellschaften. Nein! Nein!
...
die mit dem wahren Christentume verbundenen Prüfungen und Trübsale den
...
sich selbst überwindenden \footnote{"`verleugnenden"' durch "`überwindenden"'
ersetzt},
...
verfolgendes, stolzes, exzessives \footnote{"`leidenschaftliches"' durch "`exzessives"'
ersetzt}, neidisches, boshaftes,
selbstsüchtiges,
...
in einem so hohen Übermaße ausübt, daß es den schlimmsten der heidnischen
...
\textbf{keine andere,
als die innere Unachtsamkeit deines Gemüths auf das in dir scheinende Licht
...
Gottes und deinem eigenen Frieden nachteilig sein konnte, auf deiner Hut zu
...
\index{Bibelstellen:!Lukas 14)} Nicht
