...
jede Erscheinung des Bösen zu überwinden. Dieses leitet zur Betrachtung des
...
\item[9. Abschnitt] Die traurigen Wirkungen, die daraus erfolgt sind.
...
destoweniger mit deinem leeren Bekenntnisse des Christentums, deinem verderbten
Egoismus\editnote{'Selbstliebe' durch 'Egoismus' ersetzt.}
geschmeichelt,
...
fürchtet, und da er keinen Gefallen an dem ewigen Tode\index{Tod!ewiger} armer
Sünder hat, wenn
...
sollen:\biblecite{Ezechiel 18,20+23+24.}{Ezechiel 18} so hat er seinen Sohn zur
Versöhnung
...
Gerechtigkeit Gottes erkennen mögen.\bibmarginpar{Matthäus 1,21) Lukas 1,77) Hebräer
9,24-28) Johannes 2,1+2.}
\bibleindex{Matthäus 01@Matthäus 1}
\bibleindex{Lukas 01@Lukas 1}
\bibleindex{Johannes 02@Johannes 2}
...
bestraft.\bibmarginpar{Johannes 1,9) und 8,12) Epheser 5,13.}
\bibleindex{Johannes 01@Johannes 1}
\bibleindex{Johannes 08@Johannes 8}
\bibleindex{Epheser 05@Epheser 5}
\textbf{Zweitens:} Er ist nicht fern von dir, wie der
Apostel Paulus den Atheniensern von Gott erklärte,\biblecite{Apostel\-ge\-schichte
17,27.}{Apostelgeschichte 17}
...
und Abendmahl mit ihm halten, und er mit mir.}"'\biblecite{Offenbarung 3,20.}{Offenbarung 03@Offenbarung 3}
Kann nun diese Tür, wovon Christus hier redet, wohl eine andere, als die des
...
sterben, und wohin ich gehe, dahin könnt ihr nicht kommen"'}\biblecite{Johannes
8,21+24.}{Johannes 08@Johannes 8} Weil sie nicht an ihn
...
geboren sind"'}.\biblecite{Johannes 1,12+13.}{Johannes 01@Johannes 1}
...
und Blut, oder nach der Erfindung fleischlichgesinnter, mit der Wiedergeburt
...
ihn glaubten.\bibmarginpar{Matthäus 13,58) Markus 6,5-6.}
...
dir sehr wertvoll \editnote{'schätzbar' ersetzt durch 'wertvoll'.} sein.
...
\editnote{'verleugnen' ersetzt durch 'überwinden'.}
...
Kreuz auf, und folge mir."'}\biblecite{Matthäus 16,24.}{Matthäus 16}
...
befallen hat, einsiehst und genau prüfst\editnote{'reiflich erwägest'
...
bekehren
möchten;"'}\biblecite{Apostel\-ge\-schichte 26,18.}{Apostelgeschichte 26}.
Das heißt: Damit die Menschen, statt den
Versuchungen und Eingebungen des Satans,\index{Satan} des Fürsten der
...
Arbeiten (jene armen Handwerker, welche dennoch nichtsdestoweniger seine
...
ihn
zu fürchten, gesetzlos und gänzlich unbekannt mit den Wirkungen seines
...
\textit{"`das Gesetz der Sünde und des Todes"'} überwanden,\biblecite{Römer 8,2.}{Römer 08@Römer 8} war nun
...
werden;\biblecite{Jesaja 29,13.}{Jesaja 29} sie entsprang
...
züchtig, gerecht und gottselig in dieser Welt zu leben."'}\biblecite{Titus
2,11+12.}{Titus 02@Titus 2}
...
konnte."'}\biblecite{Johannes 5,18.}{Johannes 05@Johannes 5}
Denn das Licht, mit welchem Christus sie erleuchtet hatte und welches der
Böse\editnote{'der Arge' durch 'der Böse' ersezt.}
...
Menschen, sondern von Gott war."'}\biblecite{Römer 2,28-29.}{Römer 02}

\section{7. Abschnitt}  \label{kap2_ab7}

In der Tat, die Herrlichkeit des Kreuzes leuchtete aus dem Leben der
Selbstüberwindung\editnote{'Selbstverleugnung' durch 'Selbstüberwindung'
ersezt.}
...
So lange nun jener ehrliche\editnote{'lautere' durch 'ehrliche' ersezt.}
...
überzeugte Richter, und bekehrte Henkersknechte."'}\bibmarginpar{Hebräer 11,32 bis
zum Ende) Jesaja 43,2) Daniel 3,12 bis zum Ende.}
\bibleindex{Hebräer 11}
\bibleindex{Jesaja 43}
\bibleindex{Daniel 03@Daniel 3}
Kurz, die Mittel, die ihre Feinde anwendeten, sie
zu vernichten\editnote{'vertilgen' durch 'vernichten' ersetzt.}, dienten
...
den jetzigen Bekennern des Christentums normal sind\editnote{'im
Schwange gehen' ersetzt durch 'normal sind'.}.
Jene waren nicht
besorgt, wie sie ihre kostbare Zeit vertreiben und verschwenden sollten. Nein,
sie suchten dieselbe vielmehr sorgfältig zu erkaufen\biblecite{Epheser 6,15-16.}{Epheser 06@Epheser 6},
...
stellen"'}\biblecite{2.~Petrus 2,10.}{Petrus 2 02@2. Petrus 2}
...
Cäsars\personenindex{Cäsar} nicht fürchteten, so wählten sie viel lieber die
Trübsale
der wahren Pilger\index{Pilger} Christi zu erdulden, als die
Vergnügungen der
...
sich selbst überwindenden\editnote{'verleugnenden' durch 'überwindenden'
ersetzt.},
...
verfolgendes, stolzes, exzessives\editnote{'leidenschaftliches' durch
'exzessives' ersetzt.},
...
\label{ref:02_08_ursache_des_abfalls}
...
dich lehrte und fähig machte, sie zu überwinden\editnote{'verleugnen'
...
\index{Priestertum} eingeführt und auch wieder Tempel
und Altäre errichtet.}
\textit{"`Da sahen die Kinder Gottes wieder nach den Töchtern der
Menschen, wie sie schön waren."'}\biblecite{1.~Mose 6,2.}{Mose 1 06@1. Mose 6}
...
über deine Neigungen wieder, und so wurden sie dann, -- da du ihnen nachhingst~--, auch 
wieder die Gegenstände der Betrachtung, der Sorge und der Freude deines
Lebens.
...
lebendigen Erfahrung zur überlieferten Meinung,
...
Beistande des heiligen Geistes hervorgebracht werden, statt solcher Gebete,
in welchen die Alten mit Gott rangen und ihn übermochten\editnote{Im
...
eigenen Gefallen umbildetest; ungeachtet\editnote{'uneingedenk' durch
'ungeachtet' ersetzt.}
der Worte des heiligen Propheten:
\textit{"`Der Gottlosen Opfer ist dem Herrn ein Greuel;"'}\biblecite{Sprüche
15,8.}{Sprüche 15} und
dessen, was Jacobus sagt:
\textit{"`Ihr bittet, und empfanget nicht;"'} und warum
nicht? \textit{"`weil ihr übel bittet;"'}
\biblecite{Jakobus 4,3.}{Jakobus 04@Jakobus 4} nämlich mit einem
Herzen, das nicht gerade, sondern unaufrichtig ist, das nicht sich
selbst überwindet\editnote{'selbst verleugnet' ersetzt durch 'sich
selbst überwindet'.},
das nicht in dem Glauben stehet, der das Herz reinigt,
und daher
auch die Dinge nicht erlangen kann, um welche es bittet, so dass man mit
...
\label{ref:02_10_abhilfe} \textbf{Aus dieser Einsicht nun}, die
dir in deinem traurigen Abfall vom ursprünglichen
Christentume, und in der wahren Ursache desselben, -- die in nichts anderem, als
in deiner Vernachlässigung des tägliches Kreuzes Christi bestehet,~-- hier
...
\textbf{\textit{"`Wer mir
folgen will, der überwinde\editnote{'verleugne' durch 'überwinde'
ersetzt.}
...
Jünger sein."'}}
\bibmarginpar{Matthäus 16,24) Markus 8,34) Lukas 14,17.}
\bibleindex{Matthäus 16}
\bibleindex{Markus 08@Markus 8}
\bibleindex{Lukas 14} Nichts
...
durch sein tägliches Kreuz wieder gekreuzigt werden sollten. Sein Kreuz ist der
Tod der Sünde, die seinen Tod verursachte.} Er selbst aber ist
\textit{"`der Tod des Todes,"'} nach der Schriftstelle bei Hosea:
\textit{"`O Tod! ich will dir ein Gift sein!"'}\biblecite{Hosea 13,14.}{Hosea 13} (nach der englischen Bibel: "`O Tod! Ich will
dein
Tod sein."')
