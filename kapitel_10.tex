...
\editnote{'beobachten' ersetzt durch 'beachten'.}.
...
Erzväter\editnote{Ein anders Wort für 'Erzväter' ist auch
'Patriarchen'.}
und Propheten,
...
Chaucer\personenindex{Chaucer}, Spencer\personenindex{Spencer},
Waller\personenindex{Waller},
Cowley\personenindex{Cowley, Abraham}, Dryden\personenindex{Dryden}, u.a. nachlesen
...
verrät
dich."'}\biblecite{Matthäus 26,37.}{Matthäus 26)}
...
die\index{Welt!Absonderung} Nachfolger Jesus von der Welt sowohl in ihrer
...
\textit{"`deren die Welt nicht wert war?"'}\biblecite{Hebräer 11,38.}{Hebräer 11}
...
sondern durch
\textit{"`einen stillen und sanften Geist"'}\biblecite{1.~Petrus 3,4.}{Petrus 1 03@1. Petrus 3}
...
Spielen und
Zeitvertreiben\index{Zeitvertreib}, mit Komplimente machen und Schmeicheleien
...
nur bedient, um euch zu zerstreuen\index{Zerstreuung} um nicht an eueren 
...
waren gewiss nie unter den wahren Christen\index{Christ!wahrer},
...
Herrschaft\index{Herrschaft!Christi} leben! Dann würden
...
\textit{"`suchen was droben ist,"'}\biblecite{Kolosser 3,1.}{Kolosser 03@Kolosser 3}
...
\textit{"`selbst überwinden\editnote{'verleugnen' ersetzt durch
...
\textbf{Luther\personenindex{Luther, Martin}, dieser große Reformator, dessen
...
Erasmus\personenindex{Erasmus}, ein großer Gelehrter und ein so tiefer
Sprachforscher,
...
entsprungen sein. -- Lipsius\personenindex{Lipsius} versichert von den alten
Römern, dass die jetzige Art
der Begrüßung bei ihnen nicht üblich war. Und endlich gibt uns
Howel\personenindex{Howel} in seiner
...
Könige\index{König} grüßten, Stolz und Schmeichelei aber
...
wir durch die innern Züchtigungen\index{Züchtigung!durch Jesus} der göttlichen
Gnade\index{Gott!Gnade} aufrichtig gerührt und zur
...
sehen, ob sie in Gott getan sind oder nicht,"'}\biblecite{Johannes 3,13 und
20+21.}{Johannes 03@Johannes 3}
...
geben müssen."'}\biblecite{Matthäus 12,36.}{Matthäus 12}

\section{11. Abschnitt} \label{kap10_ab11}

Darum, o Leser, du magst nun ein in der Nacht sich zu Jesus schleichender
Nicodemus\personenindex{Nicodemus}, oder ein ihn verhöhnender Schriftgelehrter
...
des Hamanschen\personenindex{Haman}
...
demütigen Leben der Selbstüberwindung\editnote{'Selbstverleugnung'
...
oder Mardochai\personenindex{Mardochai} dich gegen die verachteten Christen in
...
ähnlichsten zu sein: dem stolzen Haman\personenindex{Haman}
...
Menschen, welches die Beachtung\editnote{'Beobachtung'ersetzt durch
...
ist."'}\biblecite{Matthäus 15,13.}{Matthäus 15}
