...
Die dritte Auflage (Version 3.0) beinhaltet zahlreiche Fehlerkorrekturen. die
Form und der Inhalt ist bis auf wenige Kleinigkeiten unverändert geblieben.
Im besonderen bedanke ich mich bei Dorothea Meißner die mir den maßgeblichen
Anstoß zu dieser Auflage gegeben hat, in dem sie mir über 400(!) Fehlerkorrekturen
und Verbesserungsvorschläge zugeschickt hat. Hätte es sich nur um ein paar
Dutzend Korrekturen gehandelt, hätte ich die Versionsnummer 2.1 gewählt. bei
der Menge an Änderungen hielt ich aber die Versionsnummer 3.0 für gerechtfertigt.
