...
Religion  2. in der Moral. (Seite: \pageref{kap5_ab1})
...
ihnen erweist. (Seite: \pageref{kap5_ab10})
...
konnte, aufs glänzendste geschmückt wurde. \textbf{Als ob die Menschen wieder
Juden
...
%Satz unklar
 seht unter euch üblichen Gebräuche
und zeremoniellen Beobachtungen, womit ihm gedient ist, oder welche euch diesem
Gott, der ein Geist ist, angenehm machen können. Nein! \textbf{Ihr müsst seinem
Geiste
Gehorsam leisten, der innerlich mit euch ringt \index{Gott!Mit Gott ringen}, um euch
...
die aus wiedergeborenen \index{Wiedergeborne} Gläubigen besteht, sollte jene
...
Ähnlichkeit mit dem
göttlichen Schmuck der Tochter des Königs der Himmel, der gebenedeieten
%gebenedeiet ist ein altes Wort für "gesegnet"
 und
...
geistlichen Herrlichkeit der \textit{ersten Kirche} \index{Kirche!Die erste}.
...
\index{Kreuze! Als Schmuck} Da die weltlichen \footnote{\texttt{'fleischlichen' ersetzt
durch 'weltlichen'}} Begriffe der Menschen dieses Kreuz erdacht haben, so ist
es
so beschaffen, dass weltlich Gesinnte \footnote{\texttt{'Fleischlichgesinnte' ersetzt
...
und Arbeit weltlicher Künstler verdanken? \textbf{Ist es also wohl möglich, dass
solche
...
Inneren, wo die Seele, von der Sünde geschieden, eingeklostert ist. \textbf{Diese
...
Demut, ein bloßer Kappzaum \index{Kappzaum: ist eine Art Zügel}, den der Mensch ohne Grund oder Vorschrift \index{Vorschrift} sich
...
jene unnatürliche Strenge\index{Strenge, unnatürliche}, die in keinem Zusammenhang mit den Zwecken der
...
Gedanken nicht durch einen höheren Einfluss geleitet werden, \textbf{sind in der Tat
...
&in freier Einsamkeit findet man göttliches Vergnügen?
