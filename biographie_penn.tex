...
% Möglichkeit: Zur Person und Autor William Penn
...
% möglich wäre auch "familiere Verbindungen"
\medskip
...
% möglich wäre "Sein Vater ließ sich jedoch nicht davon abhalten, sich immer wieder für seinen Sohn einzusetzen, wenn dieser mal wieder
% wegen seiner Überzeugungen im Gefängnis saß." 
\medskip
...
% ist "haften Journals" so richtig
...
% kommt belehnen von dem Wort "Lehnsherr"?
...
% "Neue Welt" würde ich auch groß schreiben, da dies insgesamt ein feststehender Begriff ist
...
% ich würde bei dem Satz "Der faire Umgang..." den Satzbau verändern
...
% dieser Abschnitt enthält interessante Informationen
