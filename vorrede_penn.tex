...
-- Ich gebe dir zu, daß du es mit einem Gott von großer Geduld zu tun hast; aber
die Zeit, in der du Gottes Geduld auf die Probe setzest, muss doch auch ein Ende
...
Hölle, in die ewige Seelenangst der Verdammten gestürzt werden. -- O Leser! ich
...
Schmelzer, der das Silber läutert\footnote{Das "`läuter"' bedeutet
"`reinigen"'}.
...
es -- auch im kümpftigen Text -- durch "`überwinden"' ersetzt.}. Lass dieselbe,
...
bewirken, und sie ist es noch. Seine Kraft ist noch dieselbe; und sie ist
...
über die Welt empor, und dein Erlösung \footnote{Im Original wird das Wort
...
oder wenn du schon gewonnen bist, ihm naher gebracht wirst. Es ist der Pfad, auf
...
aller Bitterkeit, die sie gegen einander, um vergänglicher Dinge willen, in
