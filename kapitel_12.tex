...
Kindern\index{Kind} und Dienstboten
Sklaven macht.}
...
Willst du
nun ein Kind Gottes\index{Kind Gottes} sein, ein Gläubiger, der an
Christum
glaubt, so musst du erst
ein Kind des Lichtes\index{Kind des Lichtes} werden. Du musst deine
Werke an das
...
bringen. Hätte Adam\index{Adam} im Paradies\index{Orte:!Paradies}
