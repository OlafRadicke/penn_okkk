...
Geistlichkeit\editnote{'Klerisei' ersetzt durch 'Geistlichkeit'.}, --
...
\textbf{Der Verdienst, welchen er allenfalls anderen
Gegenständen noch
...
darin nachzuahmen. Seine Erzählungen von seinem Geschlechtsregister, von der
...
Er hat an jeder Kleinigkeit etwas auszusetzen und ist
herablassend\editnote{Ursprünglich lautete der Satz: 'Er bekritelt jede
Kleinigkeit und spricht gebieterisch über alles.'}.
\label{ref:12_02_eitle_menschen_streit} \textbf{Gibt man ihm nicht nach,
so wird er beleidigend und zänkisch, doch wenn es aufs Äußerste ankommt, so
zeigt er sich feige\index{Feigheit}, aber grausam, sobald er sieht, dass er die
...
Mensch wäre, oder als hielte er Mitleid für eine Sünde\index{Sünde}. Was nicht gerade
ihn angeht, fesselt auch seine Aufmerksamkeit nicht. Er will sich über das Unglück anderer
...
oder ihnen zu
helfen\index{Helfen}.} Daher scheinen ihm Mitleid und Wohltätigkeit ebenso
überflüssig zu sein, als Demut\index{Demut} und Sanftmut ihm verhasst sind.
...
Fürsten. Sich zu unterwerfen\index{Unterordnung}
...
\index{Sklave} wäre, und Freiheit\index{Freiheit}
...
Fassung, besonders wenn er sich einbildet, dass man es mit den Achtungs- und
...
auf der einen Seite Pflicht\index{Pflicht} und Schuldigkeit verachten lehrt und auf der anderen
Liebe in Furcht verwandelt, aus seiner Frau\index{Ehefrau} eine Magd und aus seinen
...
Gastfreundschaft\editnote{'Gastfreiheit' ersetzt durch
'Gastfreundschaft'.}
...
gewährt, und wenn er könnte, so würde er sie auch so behandeln, aber 
glücklicherweise sind sie ihm an Anzahl und Kraft überlegen.}
...
Welt."'}\biblecite{Johannes 18,36.}{Johannes 18}
...
Solche heilsamen Worte als diese:
...
Füße wusch;"'}\biblecite{2.~Timotheus 2,24+25.}{Timotheus 2 02@2. Timotheus 2}
...
Vorschriften betrachtet, und es wird heutigen Tages fast für
...
sei euer Knecht."'}\biblecite{Matthäus 20,26+27.}{Matthäus 20}
...
Gottes. Hingegen ermahnt Petrus\personenindex{Petrus} die Diener des
...
Stande,"'}\biblecite{Jesaja 56,11.}{Jesaja 56} und
\textit{"`die Priester und Propheten hatten keine wahren
Gesichte,"'}\biblecite{Ezechiel 13.}{Ezechiel 13}
welche auch heutigen Tages nur zu viele
verachten.

\section{10. Abschnitt} \label{kap12_ab10}

Aber ach! Wie viel Torheit und Mangel an Religion verrät nicht endlich der
Mensch, der von sich selbst eingenommen oder auf irgend etwas, das er besitzt,
...
inwiefern man ihm ähnlich sei oder nicht, und dass man zu diesem Zweck die in
...
das Licht liebten, weil ihre Werke böse waren."'}\biblecite{Johannes 3,19.}{Johannes 03@Johannes 3}
Willst du
nun ein Kind Gottes\index{Kinder!Gottes} sein, ein Gläubiger, der an Christus
glaubt, so musst du erst ein Kind des Lichts\index{Kinder!des Lichts} werden. 
Du musst deine Werke an das Licht in deinem Inneren
...
\editnote{'Selbstverleugnung' ersetzt durch 'Selbstüberwindung'.}, ja,
und auch Überwindung\editnote{'Verleugnung' ersetzt durch
'Überwindung'.}
...
werden Gott schauen."'}\biblecite{Matthäus 5,8.}{Matthäus 05@Matthäus 5}
...
bringen. Hätte Adam\personenindex{Adam} im Paradies\index{Paradies}
...
neuen unbetretenen Weges zur Herrlichkeit?\biblecite{Hebräer 12,2.}{Hebräer 12}
...
lebendigen Wege,"'}\biblecite{Hebräer 10,20.}{Hebräer 10}
