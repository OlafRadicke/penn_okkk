...
\index{Erbsünde} \index{Sündenfall} \index{Adam} Adam
...
\index{Bibelstellen:!Mose 1 03@1. Mose 3)}
Dieser vertrieb ihn aus dem Paradies\index{Orte:!Paradies!Vertreibung}, und
...
der Unschuld in Schuld, eines Paradieses in eine Wildnis\index{Orte:!Paradies}.
Das
Schlimmste aber
...
Versucher\index{Versucher}, der sie zu
...
abgefallenen Juden\index{Jude!abgefallener}, ehe Christus erschien,
...
Die Religion der ausgearteten Juden\index{Jude!ausgearteter} brachte
...
Moses\index{Mose} und auf die göttlichen
...
Athener\index{Athener}\footnote{\texttt{'Athenienser' ersetzt duch
...
hatte, drückt sich über jene von den Juden\index{Jude} und
...
ärger als die Juden \index{Jude} gemacht.} Denn obgleich sie einen
...
schlaue böse Geist, der mit seinen Versuchungen Adam\index{Adam} um
seine Unschuld
brachte, und die Juden\index{Jude} verführte, von dem Gesetz
Gottes\index{Gebote!Gesetz Gottes}\index{Gott!Gesetz Gottes} abzuweichen, nun
auch durch eitle Lügen die Christen betrogen\index{Christ!Betrug
der} und
...
aber die falsche sogenannte Geistlichkeit\index{Geistlichker!falscher}
hat ihnen, den Verfolgungssüchtigen\index{Verfolgung}
ständig die Maus schieben muss.
Juden\index{Jude} nachahmend, den Namen der
\textit{Gotteslästerer}\index{Gotteslästerer} und
\textit{Ketzer}\index{Ketzer} beigelegt. \index{Verfolung!der
...
Geistlichkeit\index{Geistlichkeit}\index{Vervolgung!durch
...
deinen Versucher\index{Versucher},
