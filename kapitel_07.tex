...
\item[13. Abschnitt] Der Stolz, den die Menschen in ihrer falschen Erkenntnis und
eigenen Weisheit sehen, macht sie unfähig das einfache Zeugnis vom Evangelium
anzunehmen.
...
Bekenner des Christentums sich ihren Untergang dadurch zugezogen, dass sie,
...
Haupteigenschaften, dem Stolze\index{Stolz}, der Gier\editnote{'Geize'
ersetzt durch 'Gier'.} und der
Verschwendung\editnote{'Üppigkeit' ersetzt durch 'Verschwendung'.}
...
sehr richtig Stolz und Aufgeblasenheit\index{Aufgeblasenheit}.\biblecite{1.~Timotheus 3,2+4.}{Timotheus 1 03@1. Timotheus 3}
Auch waren die
...
Mit dem Stolz\index{Stolz}, diesem verderblichen Übel, mit dessen Auseinandersetzung
dieses Kapitel anfängt, begann auch das Elend des ganzen Menschengeschlechts. Er ist
...
\index{Erbsünde}\index{Sündenfall}\personenindex{Adam} Adam
...
auch so weise wie Gott selbst sein.\bibmarginpar{1.~Mose 2,19+20 und 1. Mose 3,5.}
\bibleindex{Mose 1 02@1. Mose 2}
\bibleindex{Mose 1 03@1. Mose 3}
Dieses unverzeihliche Trachten, dieser eben so törichte als ungerechte
Ehrgeiz\index{Ehrgeiz}, machte
ihn der von Gott empfangenen Wohltaten unwürdig.\biblecite{1.~Mose 3,34.}{Mose 1 03@1. Mose 3}
...
und Eva,\personenindex{Adam}\personenindex{Eva}
...
sterben."'}\biblecite{1.~Mose 2,17.}{Mose 1 02@1. Mose 2}
...
abgefallenen Juden\index{Juden!abgefallene}, ehe Christus erschien,
...
lässt;"'}\biblecite{Jakobus 3,17.}{Jakobus 03@Jakobus 3}
...
\textit{"`falsch berühmte Kunst,"'}\biblecite{1.~Timotheus 6,20.}{Timotheus 1 06@1. Timotheus 6} \label{ref:07_07_aroganz}
...
und Rachsucht\index{Rachsucht} war es, die Kain\personenindex{Kain} zum
...
Die Religion der ausgearteten Juden\index{Juden!ausgeartete} brachte
keine besseren Früchte hervor. Denn
...
Mose\personenindex{Mose} und auf die göttlichen
...
Einfluss auf dieselben als Werkzeug ihrer Bosheit gebrauchten. Daher geschah es,
dass ein heiliger Prophet auseinander gesägt, ein anderer zu Tod gesteinigt
...
\personenindex{Stephanus} Stephanus,
auszurufen:
...
ihr."'}\biblecite{Apostelgeschichte 7,51.}{Apostelgeschichte 07@Apostelgeschichte 7}
...
verkündeten,\biblecite{Johannes 11,18.}{Johannes 11}
allein die Anhänger der falschen Wissenschaft
suchten diese Botschaft durch Verleumdungen zu verdunkeln. Christus sollte
durchaus ein Betrüger sein, und dieses sollte seine Macht, Wunder\index{Wunder}
zu tun,
beweisen, welches doch gerade das Gegenteil bewies. Sie suchten oft ihn zu
...
glauben;"'}\biblecite{Johannes 11,18.}{Johannes 11}
...
\biblecite{Matthäus 11,25.}{Matthäus 11}
Eben diese falsche Weisheit hatte
auch die Gemüter der
Athener\index{Athener}\editnote{'Athenienser' ersetzt durch
'Athener'.} zu einem solchen Grad
aufgebläht, dass sie
die Predigt des Apostels Paulus\personenindex{Paulus} als eitel und töricht
verwarfen. Allein dieser
Apostel, der eine vorzüglich gelehrte Erziehung seines Zeitalters genossen
hatte, drückt sich über jene von den Juden\index{Juden} und
...
Weisheit dieser Welt zur Torheit gemacht?"'}\biblecite{1.~Korinther 1,20.}{Korinther 1 01@1. Korinther 1}
Und er
gibt weiter unten auch einen guten Grund dafür an:
\textit{"`Damit vor ihm kein Fleisch sich rühme."'}\biblecite{1.~Korinther 1,29.}{Korinther 1 01@1. Korinther 1}
...
Kunst."'}\biblecite{1.~Timotheus 6,20.}{Timotheus 1 06@1. Timotheus 6}
...
ärger als die Juden\index{Juden} gemacht.} Denn obgleich sie einen
bessern Vorgänger als die
Juden hatten, zu welchen Gott durch seinen Knecht Mose\personenindex{Mose}
...
Christentums so groß, dass ihre Ehrfurcht und Achtung fast in nichts anderem
...
Liebe, Sanftmut und Selbstüberwindung\editnote{'Selbstverleugnung'
...
schlaue böse Geist, der mit seinen Versuchungen Adam\personenindex{Adam} um
seine Unschuld
brachte, und die Juden\index{Juden} verführte, von dem Gesetz
...
herrscht."'}\biblecite{Epheser 2,2.}{Epheser 02@Epheser 2}
...
ausgaben,"'}\bibmarginpar{Ezech. 43,8) Jesaja 29,13) Matthäus 15,9.}
\bibleindex{Ezechiel 43}
\bibleindex{Jesaja 02@Jesaja 2}
\bibleindex{Matthäus 15}
ebenso auch die
...
\textit{"`Früchte der irdischen Weisheit"'} sind.
...
Stolz, dieselbe
Anmaßung sie an, den Ruf ihrer großen Diana\personenindex{Diana} durch alle
nur erdenkliche
...
Juden\index{Juden} nachahmend, den Namen der
...
damit zu tun,}\biblecite{Johannes 16,2.}{Johannes 16}
...
würden,"'}\biblecite{Apostelgeschichte 20,29.}{Apostelgeschichte 20}
...
Gewalt und Ansehen besaß und auf Fürsten und
Staaten den größten Einfluss hatte, auch immer die größten Verwirrungen,
Streitigkeiten, Blutfehden\editnote{'Blutscenen' ersetzt durch
'Blutfehden'.}, Einziehungen der Güter, Einkerkerungen und
...
überlasse ich dem Leser, dies aus eigener Erfahrung und Beobachtung zu
...
in einem so hohen Grade, auf eine so verfeinerte Art verderbt, dass die
...
sich bereit, seine gegenwärtige Stelle zu verlassen und um eine andere zu
werben, sobald diese ihm einen höhern Rang und reichlichere Einkünfte darbietet.
Es muss uns also klar einleuchten, dass Stolz und Gier\editnote{'Geiz'
ersetzt durch 'Gier'.} die beiden unglücklichen
Leidenschaften sind, von denen der gute fromme Petrus\personenindex{Petrus}
...
\index{Heimsuchung}
"`Erscheinung der heilbringenden Gnade"'\biblecite{Titus 2,11+12.}{Titus 02@Titus 2}
in deiner Seele
...
deiner Eigenliebe\index{Eigenliebe!hassen}, einsehen und hassen,\bibmarginpar{Lukas
14,26) Johannes 12,25) Matthäus 10,39.}
\bibleindex{Lukas 14}
\bibleindex{Johannes 12}
\bibleindex{Matthäus 10}
...
\textit{"`getrost und fürchten sich nicht."'}\biblecite{Psalm 112,7+8.}{Psalm 112}
