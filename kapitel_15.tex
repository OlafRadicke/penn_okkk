...
ihrer Maßlosigkeit\editnote{'Üppigkeit' ersetzt durch 'Maßlosigkeit'.},
wovon
kein Stand ausgenommen ist
\dotfill \textit{Seite~\pageref{kap15_ab1}}\\
\item[2. Abschnitt] Christus warnt seine Jünger, sich des
maßlosen\editnote{'üppigen' ersetzt durch 'maßlosen'.} Lebens nicht
...
ist, unangenem sein.
\dotfill \textit{Seite~\pageref{kap15_ab6}}\\
\item[8. Abschnitt] Das maßlose\editnote{'üppige' ersetzt durch
'maßlose'.} Leben verhindert nicht nur die Ausübung des
Guten, sondern befördert auch die Begehung des Bösen, es zerreißt das Band der
Ehe und Liebe, zerstört die Gesundheit, richtet das Vermögen zu Grund, u.v.m.
Schaubühnen und Spielhäuser sind die mächtigsten Beförderungsmittel dieser
Übel.
...
eitle\editnote{'sterben dem eitlen' ersetzt durch 'überwinden das
eitle'.}
Wesen der Welt
durch Selbstüberwindung\editnote{'Selbsverleugnung ab' ersetzt durch
...
auch Veranlassung zu jener an das Volk Israel\index{Volk Israel} gerichteten 
traurigen Botschaft,\footnote{
    Die ausschweifenden Moden, eitlen Gebräuche und Vergnügungenn des 
    gegenwärtigen Zeitalters sind, ebensowohl als jene der damaligen Zeit, dem 
    Strafgericht Gottes ausgesetzt, welches über England und Europa schwebt, 
    und über ihre europäischen Bewohner hereinzubrechen droht.}
die der Prophet Jesaias in folgenden Worten erklärte:
\textit{
    "`Darum, spricht der Herr, dass die Töchter Zions\index{Töchter
    Zions} stolz sind, und gehen mit aufgerichtetem Hals und mit geschminkten
    ...
    an ihren Füßen, (machen ein Geräusch mit ihren Füßen oder Schuhen,) darum 
    wird der Herr den Scheitel der Töchter Zions kahl machen und ihre Geschmeide
    ...
    Bisamäpfel,\footnote{ Mit wohlriechenden Sachen angefüllte und zur Zierrat 
    behängte Kapseln.} die Ohrringe, die Ringe, die Haarbänder, die Feierkleider,
    die Mäntel, die Schleier, die Beutel, die Spiegel, die 
    Koller,\footnote{Schürzen von feiner Leinwand.} die Borten, die 
    Kittel,\footnote{Feine dünne und leichte Kleider, mit welchen Staat gemacht 
    wurde.} und es wird Gestank für guten Geruch sein, und ein loses Band für einen 
    Gürtel, und eine Glatze für ein krauses Haar, und für einen weiten Mantel ein 
    enger Sack. Solches alles statt deiner Schönheit. Deine Männer werden durchs 
    Schwert fallen, und deine Krieger im Streit. Ihre Söhne werden trauern und 
    klagen, und sie wird jämmerlich (verlassen) sitzen auf der Erde."'}
    \biblecite{Jesaja 3,16-23.}{Jesaja 03@Jesaja 3}
...
auch noch des Propheten Ezechiels Vision\editnote{'Gesicht' ersetzt
durch 'Vision'.} von der unglücklichen Stadt Tyrus\index{Orte:!Tyrus}, was
für Strafen ihr Stolz und ihre Maßlosigkeit\editnote{'Üppigkeit' ersetzt
...
auf dem Meer zerbrechen, so dass alle deine Waren, (dein Reichtum,) usw.
...
herauskommen kannst."'}\biblecite{Ezechiel 27.}{Ezechiel 27}
Auf diese Weise hat Gott sein Missfallen
an dem maßlosen\editnote{'üppigen' ersetzt durch 'maßlosen'.} und
...
Kinder, und alle, die ein fremdes Kleid tragen, heimsuchen."'}\biblecite{Zefanja
1,8.}{Zefanja 01@Zefanja 1}
Solche
...
Gerechtigkeit, so wird euch alles gegeben werden."'}\biblecite{Matthäus 6,31-33.}{Matthäus 06@Matthäus 6}
...
solchen weltlichen und maßlosen\editnote{'üppigen' ersetzt durch
'maßlosen'.}
Dingen leben, keine Nachfolger Jesu\index{Nachfolger Christi}, sondern
\textit{"`den Heiden oder Völkern der Welt gleich sind, die Gott nicht
kennen."'}\biblecite{Lukas 12,22-30.}{Lukas 12}
Und da also die wahren Jünger Jesu und die
Anhänger an den vergnüglichen Dingen der Welt sich offenbar darin voneinander
unterscheiden, dass die ersteren die himmlischen Dinge wahrnehmen, die das Reich
...
und Dingen\editnote{von 'sich verdingen', also 'betreiben' oder
'arbeiten'.}
...
Ausrede\editnote{'Einwurf' ersetzt durch 'Ausrede'.}!
...
Diese Lehre von der Selbstüberwindung\editnote{'Selbstverleugnung' ersetzt
...
überwunden\editnote{'verleugnet' ersetzt durch 'überwunden'.} und
vermieden werden müsse. \textit{"`So will ich nun,"'} sagt 
Paulus,\index{Kleidung!von Frauen} \textit{"`dass die Frauen in
...
Haaren,) oder Gold, Perlen oder köstlichen Gewande;"'} -- Dergleichen war also nicht
erlaubt!~-- \textit{"`sondern, wie es Frauen, die Gottseligkeit vorgeben,
geziemt: mit guten Werken."'}\biblecite{1.~Timotheus 2,9+10.}{Timotheus 1 02@1. Timotheus 2}
Hieraus folgt unwiderruflich\editnote{'unwidersprechlich' ersetzt durch
'unwiderruflich'.}, dass
...
und Köstlichkeiten oder prächtigen Kleidern schmücken, so lange sie das tun,
keine Anspruch auf Gottseligkeit\index{Gottseligkeit} machen können, indem der
Apostel zu erkennen gibt, dass solcher Schmuck\editnote{'Putz' ersetzt durch 'Schmuck'.}
mit der christlichen Erhabenheit und Tugend nicht
...
Frauen) \textit{"`Schmuck soll nicht äußerlich sein, mit Haarflechten und Goldumhängen
oder Kleideranlegen;"'} -- Wie denn dann?~--
...
die ihr Vertrauen auf Gott setzen."'}\biblecite{1.~Petrus 3,3-5.}{Petrus 1 03@1. Petrus 3}
Dieses beweist nicht allein, dass vor Zeiten die heiligen
Frauen\index{Frau!heilige} so geschmückt waren,
...
in der Maßlosigkeit\editnote{'Üppigkeit' ersetzt durch 'Maßlosigkeit'.}
lebe,"'} in
Ansehung des Lebens aus Gott,
\textit{"`lebendig tot sei."'}\biblecite{1.~Timotheus 5,6.}{Timotheus 1 05@1. Timotheus 5}
...
Erbauung gewährt). Zieht den Herrn Jesus Christus an, und pflegt den
Körper\editnote{'wartet des Leibes'
ersetzt durch 'pflegt den Körper'.}
nicht so, dass er geil werde. Und betrügt nicht den heiligen Geist Gottes,"'} --
welches durch ein maßloses\editnote{'üppiges' ersetzt durch 'maßloses'.}
Leben geschieht;~--
...
böse Tage."'}\bibmarginpar{Philipper 3,20) Kolosser 3,2) Römer 13,13+14) Epheser
...
Hiernach könnt ihr euch nun prüfen, ihr Bewohner dieses Landes! Die ihr glaubt,
...
Vorschriften und Beispielen der Selbstüberwindung\editnote{'Selbstverleugnung'
...
O! Dass ihr der \label{ref:15_04_innere_stimme}
...
vorübergehende Freuden, eure ganzen Seelen besitzen, und sowohl über eure Zeit,
Sorgfalt und Aufmerksamkeit, als auch selbst über euer Vermögen gebieten? Lasset
euch, -- ich bitte euch im Namen des lebendigen Gottes!~-- lasset euch den Rat
...
glauben, und meinen Rat annehmen!~-- Sie enden in Schande und Kummer. 
\textbf{Er, der Allerheiligste, der getreu
...
eurem Inneren! Bestrebt euch, eure so sehr vertrödelte\editnote{'gemissbrauchte' 
ersetzt durch 'vertrödelte'.} Zeit wieder zu
...
\textbf{Die beste Erholung der Christen ist: Gutes tun. Alle ihre Gebräuche
bezielen
Mäßigkeit und irgend einen wohltätigen Zweck, der sich mehr oder weniger mit
jeder Handlung verbinden lässt.}\bibmarginpar{1.~Petrus 1,15) Hebräer 10,25) 
1.~Petrus 4,9-11)
...
\bibleindex{Matthäus 02@Matthäus 2}
\bibleindex{Philipper 02@Philipper 2}
\bibleindex{Epheser 04@Epheser 4}
\bibleindex{Mose 1 05@1. Mose 5}
\bibleindex{Psalm 001@Psalm 1}
\bibleindex{Psalm 119}
\bibleindex{Psalm 143}
\index{Beschäftigung!christliche}\textbf{Zum Beispiel, wenn Männer und Frauen ihre
Berufsgeschäfte fleißig wahrnehmen,
...
verwenden, ihren Dienstboten\index{Dienstbote} mit guten Beispiel
vorangehen, die Armen unterstützen, Kranke pflegen\index{Krankenpflege};
Gefangene besuchen\index{Gefängnis!Besuche}, zur
...
empfehlenswerter Künste\index{Kunst} und
Wissenschaften\index{Erkenntnis!Wissenschaft}, zum Beispiel
der Arithmetik\index{Erkenntnis!Arithmetik},
Geometrie\index{Erkenntnis!Geometrie}, Mechanik\index{Erkenntnis!Mechanik}, der
...
Arzneiwissenschaft\index{Erkenntnis!Medizin}, Naturkunde und dergleichen, ein
angenehmes Vergnügen für das männliche Geschlecht, so wie für das weibliche
Spinnen, Nähen, Stricken, Weberei, Gartenkunst, Einmachen der Früchte und andere nützliche
...
verderbten Neigungen zu befriedigen.\biblecite{Amos 6,3-8.}{Amos 06@Amos 6}
...
Denn
"`wie der Baum fällt, so wird er liegen."'}\biblecite{Kohelet 11,3.}{Kohelet 11}
...
\textit{"`Was ihr sät, das werdet ihr auch ernten."'}\bibmarginpar{Galater 6,4-9)
Epheser 5,6.}
...
Welt verblendet und verfinstert ist.\biblecite{Epheser 4,18-20.}{Epheser 04@Epheser 4}
Daher bestehen
auch ihre Religionsübungen bloß in einer leeren kraftlosen Wiederholung
...
welche daher Erholung in Schauspielen\index{Schauspiel}, Bällen, Spielpartien
und anderen
...
sich zu erholen, ihre Zuflucht zu den geringfügigen Tändeleien und
...
müssen,"'}\biblecite{Matthäus 12,26.}{Matthäus 12}
...
tun haben, als
\textit{"`ihren Beruf und ihre Erwählung fest zu machen;"'}\biblecite{2.~Petrus
1,20.}{Petrus 2 01@2. Petrus 1}
so würden sie weniger bemüht sein, immer neue Erholungen für ihre
...
verflossen\editnote{'entflohen' ersetzt
durch 'verflossen'.}
...
sich dadurch von ihren eitlen, fruchtlosen Erholungen und Zeitvertreiben
...
ist, von denen sie hingerissen, getäuscht und ins Verderben\index{Verderben}
gezogen werden. Ja,
...
Genusse einiger armseliger, vorübergehender Ergötzungen der Sinne aufopfern.
Lässt sich von solchen wohl sagen,
...
zu der völligen Größe Christi herankommen, und ihm ähnlich werden lässt, der das große
Muster Aller ist?"'}\bibmarginpar{Römer 6,3-8.) 1.~Korinther 12,13) Galater 3,27)
Kolosser 2,12+13)
Epheser 4,13.}
\bibleindex{Römer 06@Römer 6}
\bibleindex{Korinther 1 12@1. Korinther 12}
\bibleindex{Galater 03@Galater 3}
\bibleindex{Kolosser 02@Kolosser 2}
\bibleindex{Epheser 04@Epheser 4}
...
hängen, beweist aber nicht allein ihren Weltsinn und ihren Mangel an Kenntnis
...
verleiten lassen. Erstlich verlieren sie eine kostbare Zeit, die auf dem
...
der Pracht und dem modischen Zuschnitte seiner Kleider beurteilen und schätzen,
...
folglich auch als solche bestraft werden.\biblecite{Jakobus 2,1-10.}{Jakobus 02@Jakobus 2}
...
Kinder\index{Kinder} ganz vernachlässigt? Auch sind nicht selten die
Ausschweifungen und
...
Erfindungen der Maßlosigkeit\editnote{'Üppigkeit' ersetzt durch
'Maßlosigkeit'.}
sind jedoch die Schauspiele, diese Schulen der
Verführung, die verderblichsten, da sie das Laster reizend darstellen, und fast
immer, wo nicht von offenbar schmutzigen und schändlichen, sodoch von
...
dadurch, besonders bei jungen Leuten\index{Menschen!junge}, die
Einbildungskraft
erhitzen und die
Leidenschaften\index{Leidenschaft} aufregen. Die anderen gewöhnlichen
Belustigungen, nämlich die
Bälle, Gastereien, Spiele, und dergleichen haben sooft ähnliche nachteilige
Folgen, wie
...
Anaragoras\personenindex{Anaragoras},
Sokrates\personenindex{Sokrates}, Plato\personenindex{Plato},
Antisthenes\index{Antisth}, Heraklit\personenindex{Heraklit},
Zenon\personenindex{Zenon}, Aristides\personenindex{Aristides},
Cato\personenindex{Cato},
Cicero\personenindex{Cicero}, Epikur\personenindex{Epikur},
Seneca\personenindex{Seneca}, und
...
Reiche\index{Reich},
führen. Aber so groß ist die Anmassung der leichtsinnigen Menschen unseres
...
die schönen Namen Anstand, Artigkeit, guter Ton, Erholung und dergleichen
beilegen.
Aber, meine Freunde, gesetzt auch, es gäbe keinen Gott und weder Himmel noch
Hölle, keine Beispiele heiliger Menschen, keinen Herrn Jesus Christus, dessen
...
glauben.\bibmarginpar{Weisheit Salomos 18,14)
Psalm 52,17)
Matthäus 5,4)
Lukas 6,25)
Römer 2,7)
...
Hebräer 11,13-16)
Römer 1,25-30.}
\bibleindex{Weisheit Salomos 18}
\bibleindex{Psalm 052@Psalm 52}
\bibleindex{Matthäus 05@Matthäus 5}
\bibleindex{Lukas 06@Lukas 6}
\bibleindex{Römer 02@Römer 2}
\bibleindex{Psalm 040@Psalm 40}
\bibleindex{Römer 07@Römer 7}
\bibleindex{Hebräer 11}
\bibleindex{Römer 01@Römer 1}
...
öfteren Genuss, sich so sehr daran gewöhnen, dass sie gegen die üblen Folgen
...
hochmütigen\editnote{'hofartigen' ersetzt durch 'hochmütigen'.} Lebens
zum
...
Auf diese Weise geben sie anderen ein gutes Beispiel, leben selbst in dieser
Welt
