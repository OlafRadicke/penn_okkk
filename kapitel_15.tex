...
\textbf{Sagt nicht: wie sollten denn die Menschen sonst leben, und
...
vernachläßigt, junge Mädchen verführt, die Bande der \index{Eher!-bruch}Ehe verletzt? Was für Zank
...
sie ihre Tage in Kummer und Elend hinbringen.
\label{ref:15_08_schauspiel}
\index{Schauspiel}\textbf{Unter allen jenen unglücklichen
Erfindungen der Maßlosigkeit
\footnote{\texttt{'Üppigkeit' erstzt durch 'Maßlosigkeit'}} sind jedoch die Schauspiele, diesse Schulen der
...
Mildthaätigkeit\index{Mildtätigkeit} gegen Arme ausübten, Dürftige und Verlegene unterstüzten,
