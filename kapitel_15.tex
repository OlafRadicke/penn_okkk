...
gegenwärtigen
    ...
    welches über England und Europa schwebt, und über ihre europäischen
...
Koller,\footnote{Schürzen von feiner Leinwand.}
    die Borten, die Kittel,\footnote{Feine dünne und leichte
        Kleider, mit welchen Staat gemacht wurde.} und es wird Gestank für guten
...
deine
	...
	jämmerlich (verlassen) sitzen auf der Erde."'}\biblecite{Jesaja 3,16-23.}{Jesaja 03@Jesaja 3}
...
Diese Lehre von der Selbstüberwindung\editnote{'Selbstverleugnung'
ersetzt
...
geziemt: mit
guten Werken."'}\biblecite{1.~Timotheus 2,9+10.}{Timotheus 1 02@1. Timotheus 2}
...
Apostel zu erkennen
gibt, dass solcher Schmuck\editnote{'Putz' ersetzt durch 'Schmuck'.}
mit
...
Selbstüberwindung\editnote{'Selbstverleugnung'
...
vertrödelte\editnote{'gemissbrauchte' ersetzt
...
folglich auch als solche bestraft werden.Amely{Jakobus 2,1-10.}{Jakobus 02@Jakobus 2}
