...
Kelch, den er trank, und durch die Taufe \index{Personen:!Taufe}, die er erduldete, ein
Vorbild
...
\index{Personen:!Taufe} \index{Kelch!bitterer} \textit{"`Meinen Kelch
...
innerlich durch die Allmacht \index{Gott!Allmacht Gottes} des unsterblichen Gottes
...
ein Pilger \index{Personen:!Pilger}, der Selbstsüchtige hingegen ein Ansiedler in dieser
Welt. Jener
...
hat.} Dieser verdanken wir die Standhaftigkeit der Märtyrer, \index{Personen:!Märtyrer}
so wie ihrem
...
endlich zum Märtyrer \index{Personen:!Märtyrer}. Er wurde unter der Regierung des Könige
...
Treue Daniels \index{Personen:!Daniel}, dieses heiligen \index{Personen:!Heilige} und
...
Bosheit entarteter Fürsten und einer abgefallenen Kirche \index{Kirche!abgefallenen}
preisgaben. Unter
...
Und wie können wir hoffen, jetzt ohne dieselbe in den Himmel \index{Orte:!Himmel} zu kommen? Da
...
Gewissen vorziehet, an dem schauerlichen und allgemeinen Gerichtstage \index{Gerichtstag} der Welt \label{ref:04_21_gericht}
...
tödlich für die Eigenliebe.} Nur die Kinder!des Gehorsams, \index{Personen:!Kinder des Gehorsams} die mit dem heiligen
...
Gehorsam gegen diese innere Stimme \index{Stimme!innere}
