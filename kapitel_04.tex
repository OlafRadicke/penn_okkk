...
Kelch, den er trank, und durch die Taufe \index{Taufe}, die er erduldete, ein Vorbild
hinterlassen, wie wir seinen Fußstapfen nachfolgen sollen. Als einst des
Zebedäus Ehefrau \index{Personen:!Zebedäus Ehefrau} ihn bat, daß in seinem Reiche einer von ihren Söhnen zu
...
Niemand da war, der helfen konnte; als Keiner die Siegel \index{Siegel, Das} zu öffnen und die wahre
...
innerlich durch die Allmacht \index{Allmacht Gottes} des unsterblichen Gottes gestärkt, -- durchwanderte
...
unsers Heils, gegen welchen alle großen Alexander \index{Personen:!Alexander} und mächtigen Cäsarn der Welt \index{Personen:!Cäsarn}
weit geringer erscheinen, als die ärmsten Soldaten ihrer Heere \index{Personen:!Soldaten} gegen sie sein
konnten. Jene waren freilich große Fürsten und auch Eroberer \index{Personen:!Eroberer} ihrer Art, allein
...
Dieses ist das vollkommenste Muster der Selbstüberwindung \footnote{"`Selbstverleugnung"' duch "`Selbstüberwindung"' ersetzt}, dem wir folgen
...
\textbf{Die erlaubte Eigenliebe,} die wir zuweilen überwinden \footnote{"`verleugnen"' durch "`überwinden"' ersetzt} müssen, bestehet in dem
...
ein Pilger \index{Pilger}, der Selbstsüchtige hingegen, ein Ansiedler in dieser Welt. Jener
...
\index{Opfertod} \index{Sühnetod} \textbf{Auf diese Weise war ''Selbstverleugnug'' die beständige Uebung und der Ruhm
...
\textbf{Der Weg Gottes ist ein Weg des Glaubens; eben so dunkel für die Vernunft, als
