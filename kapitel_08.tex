...
\item[2. Abschnitt] Dieses beweist der Fall mit Korah, Dothan etc.
\dotfill \textit{Seite~\pageref{kap8_ab2}}\\
\item[3. Abschnitt] auch Abschaloms Ehrgeiz bestätigt es.
...
Dathan\personenindex{Dathan} und Abiram\personenindex{Abiram} sich
gegen Mose\personenindex{Mose} bedienten, so war es dennoch nur ihr
...
So wollte auch Abschalom\personenindex{Abschalom} die Rechte des Volkes gegen
...
Verführer seines Vaterlandes und bewog ihn, die Armee, die ihm zur
...
Auch die Türken\index{Türken} liefern einen sprechenden Beweis für
...
sehen täglich, wie die Menschen alle ihre Kräfte aufbieten, ihren Verstand
...
Trachten ihres Geistes den Vorschriften ihres Gewissens unterzuordnen und
...
stehen und als solche, die Anteil an einer bessern Welt haben, getrost und froh die
