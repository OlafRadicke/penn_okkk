...
Gedanken schmeicheln, dass ein solches Aufnehmen und Tragen desselben am Ende beim Mitternachtsgeschrei
...
\index{Vorbereitung!des Herzens} \index{Heiliger Geist!Leitung}\textbf{Wahre
...
Erlösers ganz unentbehrlich ist, da kein Beten oder Lehren bei Gott Annahme findet, 
...
\index{Reden!aus dem Geist} \index{Beten!aus dem Geist} \index{Reden!unvorbereitet}
...
ist vom Herrn."'}) \index{Andacht!Geisteszustand} \textbf{Der Mensch muss
...
\index{Selbstzufriedenen} \index{Personen:!Reiche} Allein, was geht dieses
...
diejenigen, die ihre inneren Bedürfnisse \index{Bedürfnisse!inneren} nicht
...
dass sie unvorbereitete und ungeheiligte Opfer zuliesse? \textbf{Oder wie können
wir
...
besteht allerdings eine heilige Verbindung und Gemeinschaft \index{Gemeinschaft!Heilige} 
zwischen Christo
und seinen Nachfolgern \index{Personen:!Nachfolger}, aber durchaus keine zwischen 
Christo
...
\index{Gebote!Gottesgesetz Anwendung des}\index{Gott!Gottesgesetz Anwendung des} Dieses war die
...
Judentums\index{Judenthum}, dem
heiligen Geiste widerstrebt. Und war dieses nun damals
so unter dem Gesetz\index{Gebote!unter dem Gesetz}, welches doch die Vorrichtung äusserer
in Schatten und
...
ebenso wie der, der einen Mann erschlüge, wer ein Schaf opfert, ist wie der, der einem
...
nachdrückliche Weise, seinen Abscheu dagegen, und an einem anderen Orte verbietet
...
\textbf{"`Das Rauchwerk ist mir ein Greuel, die Neumondtreffen und Sabbathe, da ihr
zusammenkommt, und Mühe und Angst habt, mag ich nicht. Und wenn ihr gleich euere
Hände ausbreitet, verberge ich doch meine Augen vor euch, und ob ihr sogleich viel
...
David \index{Personen:!David} musste in der Tat auch grosse Aufmunterung zu
...
uns,
\textit{"`habe der Herr ihm ein neues Lied in seinen Mund gelegt, um unseren Gott
zu loben."'}
\footnote{Psalm 40,4}
\index{Bibelstellen:!Psalm 40)}
...
eigenen willkürlichen Religionsübungen\index{Religionsübungen!willkürliche},
...
wahren Volk Gottes\index{Personen:!wahres Volk Gottes}, dem geistlichen, mit der
...
sinnliche Welt nicht kennt! \index{Welt!sinliche} O seliger Genuss! O köstliches
...
beugen, die alles verlassen und überwinden \footnote{\texttt{'verleugnen' ersetzt
...
würden sie die Anregungen und das Erheben seines Geistes zu ihrer Hilfe, Zubereitung
...
sondern auf die Verheißung des Vaters, auf die Taufe des Geistes \index{Taufe!des Geistes} zu
warten,
...
%das Wort fiel schon vorher irgendwo!
die Rede ist.
...
der diese geistliche Quelle \index{geistliche Quelle} mit heilbringendem Erfolg
segnet. Diejenigen,
...
%ständig steht statt "auf" das Wort "aus" - hast du da mal was generell geändert?
 die Bewegung des
...
unempfindlich oder vom Herrn nicht vorbereitet ist. \index{Andacht!innere Haltung,
}Diese müssen immer in dem
Lichte Jesu \index{Lichte!Jesu} auf die notwendige Vorbereitung ihrer Herzen
warten, indem sie
...
Israeliten \index{Personen:!Israeliten}, die in Moses'
%Der Apostroph "'" gehört hier wirklich hin.
 \index{Personen:!Mose}
...
Seelenangst sollte ihr Lohn sein. Der sinnliche Mensch \index{Personen:!Menschen!sinnliche} 
...
obgleich es ihm unerträglich ist, den Willen Gottes zu tun \index{Gott!Willen Gottes tun} 
oder zu leiden \index{Leiden}. Mit
...
Dieses ist Gott ein Greuel\index{Gott!Gott ein Greuel}.

\section{13. Abschnitt} \label{kap6_ab13}

\index{Anbetung!nötige vier Dinge} \textbf{Es gibt vier Dinge
...
Einfluss des heiligen Geistes \index{Personen:!heiliger Geist} betet, weshalb denn auch
niemand, ohne diesen
...
Begriffen, und zu viele, die für erleuchtet \index{Personen:!Erleuchtete Menschen}
...
sie, zum
Beispiel, Trübsale, Gerichte und Prüfungen \index{Prüfungen}, die köstlicher
als das so sehr
...
%also ich (kleiner Scherz, wird ja mal erlaubt sein)
...
Kananäitische} \index{Personen:!Nichtjüdisch} \index{Personen:!Heiden}, die sich
...
Welt überwunden hat."'}\index{Sieg} \index{Welt!überwinden}
...
Abrahams\index{Personen:!Kinder!Abrahams}; indem sie, dem Gehorsam des Glaubens
...
er durch die Kraft des Kreuzes Christi den Tod seiner Selbstheit\index{Tod!seiner Selbstheit} 
...
Prüfungen erduldeten, alle Feinde überwunden, selbst Gott übermochten
%"übermochten" - was könnte gemeint sein??? Vielleicht "überwanden"?
, seine
