...
ausdrücklich von Gott selbst in dem Gesetze\index{Gesetze, Gottes} verboten, das er Moses\index{Personen:!Mose} auf dem
...
Davids Habsucht offenbar hervor; Aber kam er auch ungestraft\index{Strafe Gottes} damit durch? Nein,
...
entfernt. Das Gesetz in seinem Herzen\index{Gesetz im Herzen} war in dem unglücklichen Augenblicke nicht
...
Gerichte angekündigt\index{Vergeltung Gottes}. Dem Volke Israel\index{Personen:!Volke Israel} warf Gott ehemals Gier als eine
...
Wohlfahrt\index{öffentlichen Wohlfahrt} zu befördern. David flehete,
...
aus, woran die falschen Propheten\index{Propheten, falschen} und Lehrer, die unter den Christen entstehen
...
\index{Gesetze, Mangel an} Mangel an gesetzlicher Aufsicht und Einschränkung desto gefährlicher.
...
menschlichen Gesellschaft vornehmlich dadurch, daß er den alten Geschäftsleuten\index{Geschäftsleuten}
eingiebt, die jungen Anfänger nicht aufkommen zu lassen. \index{Ausbeutung}\textbf{Und eine Hauptursache,
warum viele Menschen zu wenig erwerben, und genöthigt sind, wie Sklaven\index{Sklaven} zu
...
beherrscht, da löscht sie alle Liebe zu etwas Bessern aus. Und Mörder\index{Mörder} des Leibes
...
üben, hinging und sich erhenkte\index{Judas, Tod des}. Eine gottlose That! Ein scheußliches Ende! Aber
...
die Juden\index{Personen:!Juden} sagten dasselbe von Denen, welche die Propheten\index{Prophet} getödtet hatten; und
...
Mäßigkeit verhüten würde. Und wollten nur die Menschen in den Ausgaben für ihr Essen\footnote{"`ihren Tisch"' ersetzt durch "`ihr Essen"'}, für ihre Häuser, Möbeln\index{Möbeln}, Kleider\index{Kleider}, für ihre Spiele\index{Spiele} und andere Vergnügungen
...
und zwar nicht allein dem geistlichen\index{Bruder, geistlichen},
sondern auch dem natürlichem Bruder\index{Bruder, natürliche}.
...
den Polen, beständig kalt. Er ist ein Feind des Staatetes\index{Staatetes, Feind des}; denn er saugt das
Geld aus. Ein Krankheitsstoff im politischen Körper, der den Umlauf des Blutes
hemmt, und daher durch irgend ein Reinigungsmittel des Gesetze\index{Gesetze} fortgeschafft
...
Wissenschaften\index{Wissenschaft} als überflüssige Dinge. aus Furcht, daß die Erlernung derselben
...
Kommen die
Armen\index{Personen:!Armen, Die} aber zu ihm, so weiß er seinen Mangel an Mildthätigkeit\index{Mildthätigkeit, Mangel an} damit zu bedecken,
...
bewilligen, der vielleicht den armen Sklaven\index{Sklaven} das Leben gerettet hätte, und
starben also, bloß um Kosten zu ersparen; -- eine Standhaftigkeit, die sie zu
Märtyrern\index{Märtyrern der Geidliebe} der Geidliebe erhebt!

\section{18. Abschnitt} \label{kap13_ab18} 

Laßt uns nun aber auch sehen, was für Beispiele wir in der heiligen Schrift
antreffen, die solchen niederträchtigen Schatzsammlern\index{Schatzsammler} und Geldverbergern zur
...
bei Denen sein, die es jetzt lesen; denn da dieser Gericht Gottes\index{Gericht Gottes} erfolgte, und
...
Chrisienthumes\index{Bekenner des
...
Welt gekreuzigt\index{gekreuzigt} würden, so daß auch uns die Welt gekreuzigt wäre, und, wie in
...
Wilhelm Tinbal\index{Personen:!Tinbal, Wilhelm}, jener würdige Apostel der englischen Reformation\index{Reformation, englischen}, hat eine
...
seine Handlungen weder vor Gott und den Engeln\index{Engel}, noch vor vernünftigen Menschen
...
\textit{Es wundert mich, daß man noch kein Gesetz gegen die Gier\index{Gesetz gegen Gier} gemacht hat. Doch was
