...
-- Bestimmung und Erklärung deselben.
\dotfill \textit{Seite~\pageref{kap13_ab1}}\\
\item[2. Abschnitt] Sie besteht erstlich in einem Verlangen nach unerlaubten
Dingen.\\
...
\item[19. Abschnitt] Sünde und Gericht des Ananias und der Saphire.
\dotfill \textit{Seite~\pageref{kap13_ab19}}\\
\item[20. Abschnitt] William Tyndale Abhandlung über diesen Gegenstand,
nachgewiesen.
...
in einem unerlaubten Begehren erlaubter Dinge, und drittens in
...
Micha\personenindex{Micha} brach zu
...
David\personenindex{David, König}, dieser sonst so gute Mann, fiel aus Mangel an
Wachsamkeit. Die Schönheit
der Ehefrau des Urias\personenindex{Urias Ehefrau} war eine zu harte
Versuchung für ihn, da er, von seiner
geistlichen Wache abgelockt, entwaffnet und wehrlos war. Nichts konnte ihn nun
von seinem Vorhaben mehr zurückhalten. Urias\personenindex{Urias} musste zu
...
im Gefechte, und seine Witwe war unverzüglich Davids Ehefrau. Hieraus ging nun
...
Naboths\personenindex{Nabot} Weinberg.
Ahab\personenindex{Ahab} und Isebel\personenindex{Isabel} begehrten ihn, und
...
Belials\personenindex{Belials Kinder}, die
...
haben,"'}
sagte Elia\personenindex{Elia} im Namen des Herrn, \textit{"`sollen auch Hunde
...
Priester, lehren allesamt falschen Gottesdienst. Darum will ich ihre Frauen den
...
und wiederholte Gott durch Ezechiel\personenindex{Ezechiel} mit den Worten:
...
und er rechnet es für einen Fluch, wenn jemand ihr ergeben ist. Lukas
...
die Aufzählung derselben mit der Gier, die er Abgötterei\index{Abgötterei}
...
viele
törichte und schädliche Lüste."'} Darum rief er seinem geliebten Freunde
...
Petrus\personenindex{Petrus} hatte dieselbe Gesinnung, denn er gab den Geiz
...
unter anderen wichtigen Gegenständen, die er mit warmen Eifer einschärft, noch die
...
religiös Gesinnten, dass er oft nicht weiß, wann er genug hat, wann er mit Gewinnen
...
Wachsamkeit der Gesetze mehr als andere Laster entzogen ist, so ist sie aus
...
verwerflich, als wenn jemand das Geld bloß um des Geldes willen liebt, welches
...
verderblicheres Laster, als in dem ganzen Verzeichnisse der sündlichen
...
sind doch nichtsdestoweniger dieses Übels schuldig. Wie kann es auch anders
...
der Grenzen seiner Geschäfte bestimmen\index{Gewinnstreben begrenzen}, und nach
...
Menschen anvertrauet wurden, deren Gier sie vermochte, einen eigennützigen und
...
handeln. Ja, die Gier mordet oft Leib und Seele. Diese, indem sie das Leben auf
...
Judas\personenindex{Judas} und des
Simon Magus\personenindex{Simon Magnas}, berühren.
...
üben, hinging und sich erhängte\personenindex{Judas!Tod des}. Eine gottlose
...
die Juden\index{Juden} sagten dasselbe von denen, welche die
...
den Tag ihrer Heimsuchung\index{Heimsuchung} nicht verworfen hätten. Lasst euch
...
oder Verworfene und befindet euch in einem
verlorenen Zustande.

\section{12. Abschnitt} \label{kap13_ab12}

Der andere Gierige ist Simon\personenindex{Simon Magnas}, der Zauberer, der auch ein
...
durch Philippus\personenindex{Philippus} und Petrus offenbar wurde, und das
...
Dieses leitet mich zur Betrachtung der niedrigsten Gattung der Gier, welche die
abscheulichste von allen ist, nämlich der Anhäufung des Geldes oder der
Aufbewahrung desselben, um weder sich noch anderen damit zu nutzen\index{Reichtum!unnützer}.
Die Menschen,
welche von dieser Art der Gier gefesselt sind, gehören zu denen, von welchen
Salomo sagt,
\textit{"`dass sie bei großem Gute arm sind,"'}\biblecite{Sprüche Salomos 13,7.}{Weisheit Salomos 13}
...
verbarg, denn er hat seine Pfunde, seine Schätze, in Säcken verwahrt, im Gewölbe,
...
Ananias\personenindex{Ananias} und Saphira\personenindex{Saphira}. Es war
...
Ananias und seine Frau Saphira, als sie sich zu der Wahrheit bekannten, ihr
...
erfüllt, dass du den heiligen Geist belügst, und entwendest etwas vom Geld des
...
Gegenstände geneigt machen wolle! Es würde dem Ananiaes und der Saphira ein
...
William Tyndale\personenindex{Tyndale, William}, jener würdige Apostel der
...
Peter Charron\personenindex{Charron, Peter}, ein besonders wegen seines
...
nach Reichtum eigentlich die Gier auf das Verlangen nach Reichtum, und das
...
wägen die Güter der Erde in einer Goldwaage, da doch die Natur uns lehrt, sie
...
so hohen Wert beizulegen.} Die Natur scheint schon durch die Beschaffenheit des
...
dass in den Gegenden, wo man es findet, weder Gras noch Pflanze, noch irgendetwas Brauchbares
...
gemein ist, dass es sich auch in den Händen der gottlosesten Menschen befindet?
...
Tote binden, wie Mezentius\personenindex{Mezentius} tat, damit ihr Tod desto
schmachtender und
...
eigener größter Feind!"'} -- So sagt Charron\personenindex{Charron, Peter}, ein
weiser und großer Mann. Mein
drittes Zeugnis nehme ich aus einem Schriftsteller, der wahrscheinlich einigen
seines Witzes wegen sehr gefallen wird. Möge man aber auch seine moralischen
Bemerkungen und seine reife Beurteilung ebenso sehr schätzen.

\section{22. Abschnitt} \label{kap13_ab22}

Abraham Cowley\personenindex{Cowley, Abraham}, ein witziger und talentvoller
...
der Letztere ist allgemeiner Gegenstand des Hasses und der Verachtung. Es gibt
kein Laster, auf welches man so viele Sinngedichte gemacht hätte, und das
...
Bestrafung\index{Bestrafung} desselben, als der des Ovids\personenindex{Ovid}
in folgender Zeile:}
...
\textit{Dem Luxus mangelt vieles, dem Geiz aber alles.}
...
sage ich? Gegen sie? – Für sie, zu ihren Gunsten, wollte ich sagen.
