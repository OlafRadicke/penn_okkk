...
Gerichte angekündigt\index{Gott!Vergeltung}. Dem Volke Israel\index{Personen:!Volk Israel} warf Gott ehemals Gier als eine
...
die Gier oder die Liebe zum Gelde \textit{"`eine Wurzel alles Bösen,"'} \index{Böse!Wurzel des} und sagt uns, daß
...
in der That eine der niedrigsten Leidenschaften\index{Leidenschaft!niedrigste} ist, wovon das Herz eines
...
die Juden\index{Personen:!Juden} sagten dasselbe von Denen, welche die Propheten\index{Personen:!Propheten} getödtet hatten; und
...
Mildthätigkeit\index{Mildtätigkeit}. Wer sie nicht dazu anwendet, der gebraucht sie nicht zu dem
...
Kommen die
Armen\index{Personen:!Arme} aber zu ihm, so weiß er seinen Mangel an Mildthätigkeit\index{Mildtätigkeit!Mangel an} damit zu bedecken,
...
gewöhnlich nicht, weil Ausschweifungen\index{Ausschweifung} mit Kosten verbunden sind. -- \textbf{Doch
Christus erwiederte:
