...
eine durch Gottes Licht\index{Gott!Gottes Licht} und Geist uns gegebene
Erkenntnis}
und Empfindung des
...
Ketzerei\index{Personen:!Ketzer} und Lästerung,
vor ihnen den
...
Umgang mit deinen weltlich gesinnten Bekannten entwöhnt\index{Welt!Absonderung
von}, wenn 
du dich als einen
...
Achtung, die seine Soldaten\index{Personen:!Soldaten} ihm erwiesen, aber nicht
in
...
Ernte, so reimt sich dem Narren Ehre nicht."'}\footnote{Weisheit Salomo 26,1.}
...
gehen."'}\footnote{Weisheit Salomo 5,22+23.}~\footnote{\texttt{In der Schlachter
...
\textit{"`Ein holdseliges Weib erhalt die Ehre."'}\footnote{Weisheit Salomos
11,16}
...
angewendet, wie es aus der Frage des Ahasverus\index{Personen:!Ahasverus, König}
an
...
\textit{"`ihre Weiber zu ehren,"'}\index{Personen:!Frauen!ehren} das heißt, sie
zu lieben,
...
Ehre würdig gehalten, und die Gottlosen\index{Personen:!Gottlosen nicht ehren}
hingegen,
...
Tanzlehrer\footnote{\texttt{'Tanzmeister' ersetzt duch
'Tanzlehrer'}}\index{Personen:!Tanzlehrer} unterrichtet.
...
wenig berühmten Bischof\index{Personen:!Bischof, Disput mit} über diesen
Gegenstand
...
werden."'}\index{Personen:!Rabbi}\footnote{Matthäus 23,6}
\index{Bibelstellen:!Matthäus 23)}
...
aus Luther\index{Personen:!Luther} und Calvin\index{Personen:!Calvin} eine
Erklärung der oben 
angeführten
...
gesinntes Gemüth keinen Reiz und keine Schönheit hat. Der Apostel zeigt, dass
ein
...
edle Matrone Celantia\index{Personen:!Celantia, Matrone}, erteilte. In einer
Anweisung, 
wie sie in ihrem
