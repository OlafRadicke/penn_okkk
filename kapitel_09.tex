...
%hier habe ich im textit was geändert.
...
Heiland eine Schilderung seiner Ehrensteilen
%Ehrensteilen - was könnte gemeint sein?
 gab, sagte er zu ihm:
\textit{"`Ich habe
...
ziehen
lassen will, und um seiner großen Torheit willen wird es ihm nicht "`wohl
gehen."'}
\footnote{Weisheit Salomo 5,22+23.}
Und Christus feige Torheit
%hä? Der Satz ist wirr.
 oder
...
\textit{"`Es ist dem Mann eine Ehre, vom Hader zu bleiben,"'}
%was sind denn das auf einmal für Sätze? "vom Hader verschont zu bleiben"??
...
werden«!"'} 
%ist dieses Anführungszeichen "«" hier korrekt?
...
d.h.: sie lieben, hinsichtlich des Ranges und der Ehre, die
vornehmsten Plätze,
\textit{"`und haben es gern, wenn sie gegrüßet werden,"'}
%genau dieser Satz steht oben zwei Mal.
d. h.: sie
...
%gibt es nicht, muss anders heißen.
