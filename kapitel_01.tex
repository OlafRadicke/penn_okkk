...
und wären folglich des Teufels Kinder."'},\footnote{Johannes 8,34-45.}\index{Bibelstellen:!Johannes 08@Johannes 8)}.
...
\textit{"`Lasst euch von niemand betrügen, wer Sünde tut, der ist vom Teufel."'}\footnote{Johannes 3,7+8.}
...
\textit{"`da ernten wollen, wo er nicht gesät hat?"'}\footnote{Matthäus 25,24.}
...
"`\textit{Man kann nicht Trauben von Dornen, oder Feigen von Disteln sammeln.}"'\footnote{Matthäus 7,16.} \index{Bibelstellen:!Matthäus 07@Matthäus 7)}
...
Geist so passend
\textit{"`die Mutter der Hurerei und aller Gräuel auf Erden"'}\footnote{Offenbarung 17,5.}
...
wandeln}"'\footnote{Römer 8,9.} \index{Bibelstellen:!Römer 08@Römer 8)};
...
Gott noch größer als unser Herz, und er erkennt oder weiß alles;}"'\footnote{Johannes 3,20.} \index{Bibelstellen:!Johannes 03@Johannes 3)} das heißt:
...
"`\textit{Weicht von mir, ihr Übeltäter; ich kenne euch nicht.}"'\footnote{Matthäus 7, 23.} \index{Bibelstellen:!Matthäus 07@Matthäus 7)}
Als sagte er:
...
das seinige sein!}"'\footnote{4. Mose 23,10.} \index{Bibelstellen:!Mose 4 23@4. Mose 23)}
...
\textit{"`Siehe, das ist Gottes Lamm, welches die Sünden der Welt hinweg nimmt."'}\footnote{Johannes 1,19.}
