...
welchen die Juden angefangen haben, und dieser ist schlimmer\footnote{Im Urtext
...
sonderbaren und weltlichen \footnote{"`fleischlichen"' ersetzt duch "`weltlichen"'} 
...
und Gottesverehrung \index{wahre Religion, Die} besteht darin, dass man den 
...
Tod, welcher der Sold oder Lohn der Sünde ist. (Seite \pageref{kap1_ab10})
\end{description}
\normalsize
...
\textit{"`die Gassen des geistlich sogenannten Sodoms\index{Sodom} und Ägyptens\index{Ägypten}, wo unser Herr gekreuzigt ist."'}
...
kreuzigten, ihn gewiss innerlich kreuzigen\index{kreuzigen, innerlich}, und alle, welche jetzt die
...
sondern dass man wirklich nachfolgt. Diese Behauptung wird immer wahr bleiben,
...
\textit{"`dass er "gegrüßet seist du, Meister!"'} ausrief, und Christum küsste?
...
\index{Namenbekenntnis} reicht, ihn aber treulos verkaufen, sobald es darauf
...
sie sich den Titel der Braut\index{Braut} des Lammes\index{ Lamm}, oder der Kirche Christi, beilegt,
...
-- Wer ist auch wohl weiser als sie? Die Mutterkirche?\index{Mutterkirche}
...
\textit{"`neu Geborene"'}
\footnote{"`neue Kreaturen"' ist ersetzt duch "`neu Geborene"'}''.\footnote{Galater 6,14-16.}
